    ...
    <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  ...
                  <Stack spacing={2.5} alignItems="center">
                    ...
                    <Stack spacing={0.5} alignItems="center">
                      <Typography variant="h5">Fabien RAK</Typography>
                      <Typography color="secondary">Developer</Typography>
                    </Stack>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
      ...
      <Grid item xs={12} sm={7} md={8} xl={9}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <MainCard title="Details Personnel">
              <List sx={{ py: 0 }}>
          ...
          <Grid item xs={12}>
            <MainCard title="Experience professionnelle">
              <List sx={{ py: 0 }}>
                <ListItem divider>
                  <Grid container spacing={matchDownMD ? 0.5 : 3}>
                    <Grid item xs={12} md={6}>
