    ...
    <View style={styles.container}>
      <View style={[styles.row, styles.subRow]}>
        <View style={styles.card}>
          <Text style={[styles.title, { marginBottom: 8 }]}>Venant de :</Text>
        ...
        <View style={styles.card}>
          <Text style={[styles.title, { marginBottom: 8 }]}>Client :</Text>
      ...
      <View>
        <View style={[styles.row, styles.tableHeader, { backgroundColor: theme.palette.secondary[100] }]}>
          ...
          <Text style={[styles.tableTitle, styles.flex17]}>SERVICE</Text>
          <Text style={[styles.tableTitle, styles.flex20]}>DESCRIPTION</Text>
          <Text style={[styles.tableTitle, styles.flex07]}>QTY</Text>
          <Text style={[styles.tableTitle, styles.flex07]}>PRIX</Text>
          <Text style={[styles.tableTitle, styles.flex07]}>MONTANT</Text>
        </View>
      ...
      <View style={[styles.row, { alignItems: 'flex-start', marginTop: 20, width: '95%' }]}>
        ...
        <Text style={styles.tableCell}>
          {' '}
          Ce fut un plaisir de travailler avec vous et votre équipe. Nous espérons que vous nous garderez à l’esprit pour vos futurs projets. Merci!
        </Text>
      </View>
    </View>
  );
