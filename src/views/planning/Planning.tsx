...
import CalendarStyled from 'sections/planning/CalendarStyled';
import Toolbar from 'sections/planning/Toolbar';
import AddEventForm from 'sections/planning/AddEventForm';
...
const Planning = () => {
  ...
  return (
    <Box sx={{ position: 'relative' }}>
      ...
      <Tooltip title="Ajouter nouveau planning">
        <SpeedDial
